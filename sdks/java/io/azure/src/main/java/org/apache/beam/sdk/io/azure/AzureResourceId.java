 ...
 */
public class AzureResourceId implements ResourceId {
  ...
  public ResourceId resolve(String other, ResolveOptions resolveOptions) {
    if (resolveOptions == ResolveOptions.StandardResolveOptions.RESOLVE_DIRECTORY) {
      ...
      return new AzureResourceId(uri.resolve(other));
  ...
  public ResourceId getCurrentDirectory() {
    return new AzureResourceId(uri.getPath().endsWith("/") ? uri : uri.resolve("."));
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof AzureResourceId)) {
      return false;
    }
    return Objects.equals(uri, ((AzureResourceId) obj).uri);
  }
