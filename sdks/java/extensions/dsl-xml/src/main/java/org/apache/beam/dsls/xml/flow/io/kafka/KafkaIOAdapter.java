...
package org.apache.beam.dsls.xml.flow.io.kafka;

import com.google.auto.service.AutoService;

import javax.annotation.Nonnull;

import org.apache.beam.dsls.xml.flow.io.AbstractIOAdapter;
import org.apache.beam.dsls.xml.flow.io.IOAdapter;
import org.apache.beam.dsls.xml.flow.io.kafka.config.KafkaConsumerConfiguration;
import org.apache.beam.dsls.xml.flow.io.kafka.config.KafkaProducerConfiguration;
import org.apache.beam.dsls.xml.flow.metadata.IOConfiguration.KafkaCommonConfiguaration;
...
public class KafkaIOAdapter extends AbstractIOAdapter {
  ...
  private Read getBasicKafkaIOReader() {
    return KafkaIO.read()
  ...
  /*
   * (non-Javadoc)
   * @see org.apache.beam.dsls.xml.flow.io.IOAdapter#getHandlerSchema()
   */
  @Override
