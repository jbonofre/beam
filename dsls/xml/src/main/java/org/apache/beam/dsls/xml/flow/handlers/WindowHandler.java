...
package org.apache.beam.dsls.xml.flow.handlers;
...
import org.apache.beam.dsls.xml.flow.metadata.model.SupportedType;
...
public class WindowHandler<K, V> extends AbstractStepHandler<KV<K, V>, V> {
  // SerializableFunction<Iterable<Integer>, Integer>
  /** Generated Serial Version ID. */
  private static final long serialVersionUID = -4660017432493403419L;

  @Override
  public WindowHandler<K, V> assign(StepType metadata, PCollection<KV<K, V>> input) {
  ...
  public PCollection<V> apply() throws PipelineDefinitionException {
    ...
    boolean assignableFrom = WindowFn.class.isAssignableFrom(getFunClass());
    if (!assignableFrom) {
